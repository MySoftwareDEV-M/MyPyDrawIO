...
class Edge(Element.Element):
    ...
    # Public functions
    #----------------------------------------------------------------------------------------------
    def entry(self, format = "list"):
        """
        Returns the entry point in the selected format.
        format: 
        - "list" --> list
        ...
        """
        style = self.style()
        return style.entry(format)
    
    #----------------------------------------------------------------------------------------------
    def exit(self, format = "list"):
        """
        Returns the exit point in the selected format.
        format: 
        - "list" --> list
        - "dict" --> dictionary with keys x, y, dx, and dy.
